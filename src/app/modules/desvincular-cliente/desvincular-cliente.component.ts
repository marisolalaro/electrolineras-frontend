...
// moduls
import { DesvincularClienteModule } from './desvincular-cliente.module';
// modeles
...
@Component({
  selector: 'app-desvincular-cliente',
  templateUrl: './desvincular-cliente.component.html',
  styleUrls: ['./desvincular-cliente.component.scss'],
  standalone: true,
  imports: [
    DesvincularClienteModule,
    ReactiveFormsModule
  ],
  providers: [
    ConfirmationService
...
export default class DesvincularClienteComponent {
  ...
  public componentTitle: any = mainTitles['desvincularCliente'];
  ...
  constructor(
    ...
    public brandservice: DesvincularClienteService,
